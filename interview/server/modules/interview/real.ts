 ...
 */
function anchorOfQuestion(knowledgeRoot: string, relative: string, title: string): string {
 ...
 */
export function linkKnowledge(markdown: string, knowledgeRoot: string): string {
...
export function listRealInterviews(root: string) {
 ...
 */
export function readRealInterview(root: string, id: string, { knowledgeRoot = "" }: { knowledgeRoot?: string } = {}) {
