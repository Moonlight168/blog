 ...
 * 但历史列表是 `--follow` 出来的，会跟着改名一路走——简历从 `resume/` 挪进 `zhangsan/`、
 ...
 * 花括号压缩（`resume/zhangsan/{自我介绍.md => 自我介绍/技术面.md}`），不是一个能直接用的路径。
 *
 * `core.quotepath=false` 不能省：默认情况下 git 会把非 ASCII 路径转义成
 * `"resume/zhangsan/\350\207\252..."`，那串东西拿去 show 是找不到的。
 */
...
export function unquotePath(name: string): string {
 ...
 */
export function commitPathAt(repo: string, relative: string, hash: string): string {
