...
import { elapsedMs, expired, remainingMs, type TimedSession } from "../../../server/modules/interview/timer.ts";

const START = "2026-09-12T10:00:00.000Z";
const at = (offsetMinutes: number): number => new Date(Date.parse(START) + offsetMinutes * 60_000).getTime();
