...
### 2. OilGuard（油品质量智能分析平台） — 后端开发

**项目描述：**

面向工业油品检测运维场景，参与油品检测数据分析平台的开发工作，涵盖数据审核、阈值告警、自动报告与 AI 智能问答等模块。
...
实现检测数据审核、报告生成的自动化处理，减少人工重复操作，适配工业检测数据管理规范。

🔗 [项目详情](/series/myprojects/OilGuard/README.md)
